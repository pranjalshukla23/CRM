...
# creating a signup form inheriting the UserCreation form
class SignUpForm(UserCreationForm):
    ...
    class Meta:
        ...
        model = User
        # specify the fields to use in the form and the order in which they will be displayed in form
        fields = ('username', 'first_name', 'last_name', 'email', 'password1', 'password2')
        
    def __init__(self, *args, **kwargs):
        super(SignUpForm, self).__init__(*args, **kwargs)
        # add css to other fields in the form
        self.fields['username'].widget.attrs['class'] = 'form-control'
        self.fields['username'].widget.attrs['placeholder'] = 'User Name'
        self.fields['username'].label = ''
        # add text to display if the value entered is incorrect in the form
...
class AddRecordForm(forms.ModelForm):
    ...
    class Meta:
        # store data in Record model
        model = Record
        # fields to exclude in the form
        exclude = ("user", )